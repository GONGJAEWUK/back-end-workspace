...
public void practice2() {
	...
	String result2 = (ch>='A' && ch <= 'Z') ? "알파벳 대문자이다." : "알파벳 대문자가 아니다.";
...
public void practice3() {
	...
	String result = op == '+' ? num1 + "+" + num2 + "=" + (num1 + num2) : op == '-' ? 
			num1 + "-" + num2 + "=" + (num1 - num2) : "잘못 입력했습니다";
	
	System.out.println(result);

	// 또다른 방법 1: 조건문 사용(이건 다음주 월요일!)
	if(op == '+' || op == '-') {
	...
	result = op == '+'
			? String.format("%d + %d = %d", num1,num2,(num1+num2)) : op == '-' ? 
			  String.format("%d - %d = %d", num1,num2,(num1 - num2)) : "잘못 입력했습니다.";
