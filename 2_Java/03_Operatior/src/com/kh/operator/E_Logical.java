...
public class E_Logical {
	...
	public void method1() {
	   ...
	   System.out.println("정수값 입력해주세요 > ");
	   int number = sc.nextInt();
	   
	  boolean result = 1 <= number && number <= 100;
	  
	  System.out.println("1부터 100 사이의 값인가요? " + (number<= 100 && number >= 1));
