...
public class D_Scanner {
	...
	public static void main(String[] args) {
		...
		System.out.println("당신의 이름은 " + name + "이고 사는곳은" + 
		add + ", 나이는" + age + "살, 키는" + height + "cm, 성별은 " + gender + "입니다.");
		
		//printf 변경
     
		System.out.printf("당신의 이름은 %s 이고 사는곳은 %s 나이는 %d살,키는 %.1fcm, 성별은 %c입니다.",name,add,age,height,gender);
	}
