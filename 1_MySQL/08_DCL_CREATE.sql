...
INSERT INTO member VALUES(2,'user02','pass02','공재욱','남','010-7310-4769', 'aaa@google.com','2024-05-28');
...
INSERT INTO mem_check
VALUES(1,'user02','pass02','장성일','ㄴ',null,null,null);
-- >> check 제약조건에 위배되었기 때문에 오류 발생!

INSERT INTO mem_check
VALUES(1,'user02','pass02','장성일',null,null,null,null);
-- >> check 제약조건으로 not null 조건 또한 위배되었음을 확인!

INSERT INTO mem_check
VALUES(1,'user02','pass02','장성일','남',null,null,null);
...
/*
    ...
    - PRIMARY KEY 제약 조건을 부여하면 그 컬럼에 자동으로 NOT NULL + UNIQUE 조건이 설정
    - 한 테이블 당 오로지 한 개만 설정
    --> 간혹 복합키 설정도 가능
*/
...
DELETE FROM mem_grade 
WHERE grade_code = 3;
-- >> 자식 테이블(member)에 3이라는 값을 사용하지 않기 때문에 삭제가 가능
...
/*
     ...
     - 삭제 옵션 : 부모 테이블의 데이터 삭제 시 그 데이터를 사용하고 있는 
	    자식테이블의 값을 어떻게 처리할건지 
...
SELECT * FROM kh.employee;
CREATE TABLE employee_copy
SELECT emp_no,emp_name,salary, salary *12 FROM kh.employee;
select* FROM employee_copy;