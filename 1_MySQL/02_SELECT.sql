/*
 ...
 : 관계형 데이터베이스에서 데이터를 조회하거나 조작하기 위해 사용하는 표준 검색 언어
   ...
   4. DDL(Date Definition Language) : 데이터 정의어
	   - DMBS에 구조를 정의하거나 변경, 삭제하기 위해 사용하는 언어
...
/*
    컬럼 산술 연산
    - SELECT 절에 컬렴명 입력 부분에 산술연산자를 사용하여 결과를 조회할 수 있다.
...
SELECT emp_id "사번", emp_name "직원명", salary "급여",'원'
FROM employee;
...
-- employee 테이블에 부서 코드(dept_code) 조회
...
-- 4. 재직중(ent_yn 컬럼 값이 'N')인 사원들의 사번, 사원명, 입사일(hire_date) 조회
...
-- 전화번호의 3번째 자리가 1인 사원들의 사번(emp_id),사원명,전화번호, 이메일(email)
